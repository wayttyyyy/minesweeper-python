...
def test_board_initialization():
    ...
    actual_mines = sum(1 for r in range(5) for c in range(5) if board.grid[r][c].is_mine)
    assert actual_mines == 5


# Тест 2: Перевірка логіки прапорців (використання фікстури)
...
@pytest.mark.parametrize("mine_coords, check_r, check_c, expected_count", [
    ...
    ([(0,0), (0,1), (0,2), (1,0), (1,2), (2,0), (2,1), (2,2)], 1, 1, 8) # Міни навколо центру
])
